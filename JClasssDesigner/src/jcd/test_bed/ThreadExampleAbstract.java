 ...
 * @author brobi
 */
public class ThreadExampleAbstract extends Application{
    ...
    public ThreadExampleAbstract()throws Exception{
    ...
    private void makeThreadExample() {
        ...
        box.setClassName("ThreadExampleAbstract");
